...
import frc.robot.subsystems.Turret.LaunchCalculator2;
...
public class HoodSim extends SubsystemBase {
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("Hood/HoodSim/Auto hood angle", getHoodAngle2());
  }

  public void autoAim(){
    double setpoint = MathUtil.clamp(getHoodAngle2(), 0, 180);
    setDeg(setpoint);
  }
  ...
  public double getHoodAngle2() {
    ...
    return LaunchCalculator2.getInstance().getParameters(swerve, -1.0).hoodAngle();
  }
