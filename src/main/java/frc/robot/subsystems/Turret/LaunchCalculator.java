...
//       LoggedTunableNumber hoodAngleDeg, LoggedTunableNumber flywheelSpeed) {}
  ...
  static {
    ...
    hoodAngleMap.put(2.2 + hubOffset, 0.3);
    hoodAngleMap.put(2.5 + hubOffset, 0.3);
    hoodAngleMap.put(2.8 + hubOffset, 0.3);
    hoodAngleMap.put(3.1 + hubOffset, 0.3);
    hoodAngleMap.put(3.4 + hubOffset, 0.3);
    hoodAngleMap.put(3.7 + hubOffset, 0.4);
    ...
    flywheelSpeedMap.put(1.9 + hubOffset, 52 + speedOffset);
    flywheelSpeedMap.put(2.2 + hubOffset, 48 + speedOffset);
    flywheelSpeedMap.put(2.5 + hubOffset, 51 + speedOffset);
    flywheelSpeedMap.put(2.8 + hubOffset, 53 + speedOffset);
    flywheelSpeedMap.put(3.1 + hubOffset, 55 + speedOffset);
